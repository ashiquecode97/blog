...
@section('title', 'Edit Post - My Blog')
...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="mb-8 fade-in">
        ...
        <p class="text-gray-600 text-lg">Update your post content</p>
    </div>
        ...
        <form action="{{ route('posts.update', $post->slug) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <textarea id="content" 
                          name="content" 
                          rows="16"
                          class="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition font-mono"
            ...
            <div class="bg-gray-50 rounded-lg p-6 border-2 border-dashed border-gray-300">
                ...
                <div class="mb-4">
                    <label for="featured_image" class="block text-sm text-gray-600 mb-2">
                        📤 Upload New Image (JPEG, PNG, GIF, WebP - Max 2MB)
                    </label>
                    <input type="file" 
                           id="featured_image" 
                           name="featured_image" 
                ...
                <div>
                    ...
                    <input type="url" 
                           id="image_url" 
                           name="image_url" 
                           value="{{ old('image_url', str_starts_with($post->featured_image ?? '', 'http') ? $post->featured_image : '') }}"
                           class="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition"
            ...
            <div class="bg-blue-50 border-2 border-blue-200 rounded-lg p-4">
                <label class="flex items-center cursor-pointer">
                    ...
                    <span class="ml-3">
                        <span class="text-sm font-bold text-gray-700 block">Publish post</span>
